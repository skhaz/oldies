 ...
 *                                                                             *
 * Versão deste documento: 0.01 (22/03/06)                                     *
 * Responsável da Versão: Equipe MDD                                           *
 * Descrição: Implementação da Classe CAudioManager                            *
 *                                                                             *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

#include "../Globals.h"

#ifndef _CAudioManager_h
#define _CAudioManager_h
